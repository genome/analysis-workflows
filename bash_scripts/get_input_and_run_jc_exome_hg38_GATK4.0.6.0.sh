...
#Input
analysis_ID=$1
main=/gscmnt/gc2698/jin810/cromwell/lek_joint_genotyping_jinlab_gatk-4.0.6.0.wdl
...
-oo /gscmnt/gc2698/jin810/jointcalling/"$analysis_ID"/GATK4.0.6.0_bsub_exec.out -eo /gscmnt/gc2698/jin810/jointcalling/"$analysis_ID"/GATK4.0.6.0_bsub_exec.err \
